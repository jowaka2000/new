...
<body class="bg-blue-900">
    ...
    <div class="flex w-full justify-center px-3 md:px-8 py-10">
        <div class="flex justify-end w-full md:w-8/12">
            <a href="{{route('home')}}" class="flex text-gray-100 border border-gray-400 hover:border-red-300 hover:text-red-500  rounded p-1">
    ...
    <div class="flex w-full justify-center px-3 md:px-8 pb-10">
        ...
        <div class="w-full md:w-5/12 bg-blue-600 h-full overflow-y-auto">
