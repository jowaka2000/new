...
@section('content')
    <div class="w-full bg-slate-300 h-full space-y-5 pb-12">
        ...
        <a href="{{ route('post.create') }}"
            class="fixed right-16 md:right-60 bottom-28 rounded-full bg-green-500 p-2 hover:bg-green-600">
        ...
        {{-- message --}}
        <a href="" class="fixed right-16 md:right-60 bottom-10 rounded-full bg-green-500 hover:bg-green-600 p-2">
        ...
        <div class="px-3 md:px-10 pt-5">
            ...
            @if (count($trending) == 0)
                <div class="text-xl w-full flex justify-center py-5 text-gray-700">No Trending Items yet</div>
            @endif
        ...
        <div class="px-8 md:px-10">
            ...
            @if (count($posts) == 0)
                <div class="text-xl w-full flex justify-center py-5 text-gray-700">No Items Posted yet yet</div>
            @endif
